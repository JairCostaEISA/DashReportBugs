...
# Criando a string de conexão para o SQL Server com o driver ODBC 17
conexaoBaseQC = f'DRIVER={{ODBC Driver 11 for SQL Server}};SERVER={host};DATABASE={dbname};UID={user};PWD={password}'
